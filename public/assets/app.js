                    ...
                    <div class="glass-card p-5 md:p-6 rounded-2xl h-full flex flex-col justify-between group">
                        ...
                        <div class="pt-4 border-t border-slate-200/60 mt-auto flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-xs font-semibold text-slate-800">${pembimbingArr.length ? pembimbingArr.map(p => `<span class="block truncate">${escapeHtml(teacherManager.getTeacherLabel(p))}</span>`).join('') : '-'}</p>
                            </div>
                        </div>
                    </div>`;
                }).join('');
