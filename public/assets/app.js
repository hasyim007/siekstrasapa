        ...
        const api = {
            ...
            push(type, data) {
                ...
                // Tipe data admin-only sekarang divalidasi di server (worker.js) --
                // wajib sertakan password admin yang tersimpan sejak login berhasil,
                // supaya request ini tidak ditolak (401) oleh server.
