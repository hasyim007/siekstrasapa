        ...
        const classManager = {
            ...
            // Parser CSV sederhana: cukup untuk 2 kolom "Kelas,Nama Siswa" tanpa koma di dalam
            // nama. Menangani quote ganda ("...") kalau ada, karena Excel kadang membungkus
            // nama yang mengandung koma dengan tanda kutip saat "Save As CSV".
            _parseCSV(text) {
                const rows = [];
                text.split(/\r?\n/).forEach(line => {
                    if (!line.trim()) return;
