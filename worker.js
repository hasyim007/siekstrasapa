...
const ALLOWED_TYPES = ['kelas', 'ekskul', 'survey', 'siswa', 'gallery', 'usulan', 'settings', 'notif', 'saran', 'arsip', 'guru'];
...
// "guru" (Master Data Guru/Pelatih) ditambahkan ke daftar ini karena hanya boleh
// diubah lewat halaman Master Guru/Pelatih (guru.html, halaman admin) -- persis
// alasan yang sama dengan "kelas"/"siswa" di atas.
